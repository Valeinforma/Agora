    ...
    public class AgoraContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>().HasData(
                new Usuario { Id = 1, Nombre = "Admin", Email = "admin@gmail.com", Password = "admin123", TipoUsuarioEnum = Service.Enums.TipoUsuarioEnum.Administrador },
                new Usuario { Id = 2, Nombre = "Juan Perez", Email = "perez@gmail.com", Password = "juan123", TipoUsuarioEnum = Service.Enums.TipoUsuarioEnum.Estudiante });
